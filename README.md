About terraform-provider-azurerm-feedstock
==========================================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/terraform-provider-azurerm-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/terraform-provider-azurerm-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add terraform-provider-azurerm
# for installing globally
pixi global install terraform-provider-azurerm
```
...
It is possible to list all of the versions of `terraform-provider-azurerm` available on your platform:
...
```
pixi search terraform-provider-azurerm --channel conda-forge
```
